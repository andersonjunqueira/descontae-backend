...
insert into tb_marca_franquia(id_marca_franquia, nome, logo) values (1, 'SUBWAY', 'http://descontae.com.br/img/logos/17_thumb.jpg');
insert into tb_marca_franquia(id_marca_franquia, nome, logo) values (2, 'Chiquinho Sorvetes', 'http://descontae.com.br/img/logos/70_thumb.jpg');
insert into tb_marca_franquia(id_marca_franquia, nome, logo) values (3, 'Burger King', 'http://descontae.com.br/img/logos/68_thumb.jpg');
...
-- REVISTA
insert into tb_revista(id_revista, edicao, descricao, inicio_vigencia, fim_vigencia)
...
insert into tb_unidade(id_unidade, nome, telefone, id_empreendimento, inicio_expediente, fim_expediente, id_endereco)
values (1, 'SUBWAY 304N', '6112345678', 1, null, null, 2);

insert into tb_oferta(id_oferta, descricao, imagem, valor, desconto, id_pessoa, situacao)
values (1, 'DESCONTO 10%', '', null, 0.1, 1, 'A');
...
insert into tb_unidade(id_unidade, nome, telefone, id_empreendimento, inicio_expediente, fim_expediente, id_endereco)
values (2, 'SUBWAY 706N', '6112345678', 1, null, null, 3);
...
insert into tb_unidade(id_unidade, nome, telefone, id_empreendimento, inicio_expediente, fim_expediente, id_endereco)
values (3, 'SUBWAY 405S', '6112345678', 2, null, null, 5);

insert into tb_oferta(id_oferta, descricao, imagem, valor, desconto, id_pessoa, situacao)
values (2, 'Subway Club por R$5,00', '', 5.00, null, 2, 'A');
...
insert into tb_unidade(id_unidade, nome, telefone, id_empreendimento, inicio_expediente, fim_expediente, id_endereco)
values (4, 'CHIQUINHO 304N', '6112345678', 3, null, null, 7);

insert into tb_oferta(id_oferta, descricao, imagem, valor, desconto, id_pessoa, situacao)
values (3, 'Compre 1 casquinha e leve 2', '', 1.00, null, 3, 'A');
